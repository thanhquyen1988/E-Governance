...
class Committee1 extends Component {
    componentWillMount() {
  ...
  constructor() {
    super();
    this.state = {
      fields1: {Address:'', Information:'', AES:'', AES_KEY_Cipher:'', AES_KEY_Cipher_2:''},
      fields2:'',
      fields3:'',
      errors: {},
      errors1: {},
...
//////////////////////////////////////////////////////////
  ...
  async submituserRegistrationForm1(e) {
    ...
    // Người gửi khởi tạo cặp khóa Public và Private của thuật toán RSA
      ...
      console.log("Day la thong tin Police: "+fields1.Information);
      ...
      //Download file JSON from IPFS
        ...
        await ipfs.files.add(buf, (error, result) => {
          ...
          this.state.contract.methods.Them_Canhsat(Address, result[0].hash, result[0].hash).send({
            from: this.state.account,
            gas: 3000000
          }, (error, transactionHash) => {
            alert(" Thêm Cảnh sát thành công!");
  ...
  render() {
    return (<div>
      <ol className="breadcrumb">
        ...
        Ủy ban (Quản lý thông tin Cảnh sát)
        </li>
              ...
              <div className="Commitee1">
                <span className="md-headline" align="center"  > Đăng ký Cảnh sát</span>
                <form method="post" name="userRegistrationForm" onSubmit={this.submituserRegistrationForm1}>
                <div className="form-input">
                    <label htmlFor="first_name" className="required"> Tài khoản Cảnh sát</label>
                  ...
                  <div className="form-input">                    
                    <label htmlFor="first_name" className="required"> Thông tin Cảnh sát</label>

    ...
    handleChange1(e) {
      ...
      validateForm() {
        ...
        if (!fields["Certificate_Code"]) {
          formIsValid = false;
          errors["Certificate_Code"] = "*Vui lòng nhập Mã Bằng cấp!";
        }
      ...
      validateForm1() {
        ...
        if (!fields1["Employee_Code"]) {
          formIsValid = false;
          errors1["Employee_Code"] = "*Vui lòng nhập Mã nhân viên!";
        }
    ...
    return (<div>
      ...
      Doanh nghiệp
        ...
        <div className="Police1">
                <span className="md-headline" align="center"  > Thông tin Bằng cấp</span>
                <form method="post" name="userRegistrationForm" onSubmit={this.submituserRegistrationForm}>
                  <div className="form-input">
                    <label htmlFor="first_name" className="required"> Mã Bằng cấp</label>
                  ...
                  <div className="form-submit">
                    <input type="submit" value="Xem Bằng Cấp" className="submit" id="submit" name="submit" />                                      
                  </div>              
                  ...
                  <div className="form-input">
                    <label htmlFor="company" class="fa fa-user" aria-hidden="true" style={{fontWeight:"bold",color: "black"}}> Ngày tốt nghiệp</label>
                  ...
                  <div className="form-input">
                    <label htmlFor="company" class="fa fa-user" aria-hidden="true" style={{fontWeight:"bold",color: "black"}}> Chuyên ngành</label>
      ...
      <div className="Police2">
                <span className="md-headline" align="center"  > Thêm Nhân viên</span>
                <form method="post" name="userRegistrationForm" onSubmit={this.submituserRegistrationForm1}>
                  ...
                  <div className="form-input">
                    <label htmlFor="company" className="required"> Mã Nhân viên</label>

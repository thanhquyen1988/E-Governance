...
class Committee2 extends Component {
    componentWillMount() {
...
//////////////////////////////////////////////////////////
  ...
  async submituserRegistrationForm1(e) {
    ...
    // Người gửi khởi tạo cặp khóa Public và Private của thuật toán RSA
      ...
      console.log("Day la thong tin School: "+fields1.Information);
      ...
      //Download file JSON from IPFS
        ...
        await ipfs.files.add(buf, (error, result) => {
          ...
          this.state.contract.methods.Them_TruongHoc(Address, result[0].hash, result[0].hash).send({
  ...
  render() {
    return (<div>
      <ol className="breadcrumb">
        ...
        Ủy ban (Quản lý thông tin Trường học)
        </li>
              ...
              <div className="Commitee1">
                <span className="md-headline" align="center"  > Đăng ký Trường học</span>
                <form method="post" name="userRegistrationForm" onSubmit={this.submituserRegistrationForm1}>
                <div className="form-input">
                    <label htmlFor="first_name" className="required"> Tài khoản Trường</label>
                  ...
                  <div className="form-input">                    
                    <label htmlFor="first_name" className="required"> Tên trường</label>
                  ...
                  <div className="form-input">                    
                    <label htmlFor="first_name" className="required"> Thông tin Trường</label>
